...
st.write("Transform your files between CSV and Excel format with built-in data cleaning & visualization for Quarter 3.")
...
if uploaded_files:
    for file in uploaded_files:
        ...
        st.subheader(f"Cleaning Data Options for {file.name}")
